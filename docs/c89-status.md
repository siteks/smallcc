...
| Arrays (1-D and N-D) | ✅ | |
| `struct` | ✅ | Including nested structs, correct member offsets, assignment (`s1 = s2`), and return by value (callee-local slot + immediate caller copy-out — see `abi.md` §4.4) |
