...
smallcc: smallcc.c tokeniser.c parser.c types.c codegen.c backend.c preprocess.c optimise.c risc_backend.c ir3.c braun.c linscan.c ir3_lower.c ir3_opt.c
sim_c: sim_c.c
